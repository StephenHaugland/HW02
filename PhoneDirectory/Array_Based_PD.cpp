...
/** Remove an entry
	...
	*/
string Phone_Directory::remove_entry(const string& name) // Stephen Haugland completed this function
//  Exercise 1.7: please complete the remove_entry() method - Ed/Kent
{
